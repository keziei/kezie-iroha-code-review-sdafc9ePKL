...
# Enable Merge Incremental Backup (Incrementally Updated Backups)
# Retain other backup types disabled (Full, L0/L1)
# Recovery window of 4 days (sysdate-3)
...
echo +++++++++++++++++++++++++++++++++
(crontab -l 2>/dev/null; echo "# Daily Incrementally Updated Backup")| crontab -
(crontab -l 2>/dev/null; echo "0 2 * * * ${SCRIPTDIR}/daily_inc_updated_backup_$ORACLE_SID.sh")| crontab -
