...
## Author: Kezie Iroha v1.02 modified memory ratios for ram allocation
## Author: Kezie Iroha v1.021 Modified fast size, added stats gather after sga change
## Author: Kezie Iroha v1.022
## Author: Kezie Iroha v1.023
## Author: Kezie Iroha v1.024 Reduced parallel degree to 2, to account for small cpu allocations
# Author: Kezie Iroha v1.025 required param is now oracle-sid only
